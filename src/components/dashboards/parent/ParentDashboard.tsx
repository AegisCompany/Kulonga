...
import { GraduationCap, Calendar, BarChart3, Bell, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard label="Média do Educando" value="15.8" icon={GraduationCap} color="bg-brand-green" />
        ...
        <StatCard label="Mensagens" value="2" icon={Bell} color="bg-brand-orange" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <h3 className="font-bold text-lg mb-6 text-brand-green">Desempenho do Educando</h3>
